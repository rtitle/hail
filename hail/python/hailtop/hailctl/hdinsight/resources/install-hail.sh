...
/usr/bin/anaconda/bin/conda create -n py39 python=3.9 --yes
source /usr/bin/anaconda/bin/activate py39
...
#jupyter server extension enable --user --py sparkmonitor
...
mv /usr/bin/anaconda/envs/py39/bin/python /usr/bin/anaconda/envs/py39/bin/python.bak
